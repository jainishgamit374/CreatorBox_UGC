...
import { Search, Globe, Video, Zap, ShieldCheck, ArrowRight, Play } from 'lucide-react';
...
const bestWork = [
  { title: 'Skincare Unboxing Reel', category: 'Skincare', goal: 'Conversions', platform: 'Meta Ads' },
  { title: 'Fashion Try-On UGC', category: 'Fashion', goal: 'Engagement', platform: 'Instagram' },
  { title: 'Product Demo — Electronics', category: 'Electronics', goal: 'Trust', platform: 'YouTube Shorts' },
  { title: 'Amazon Listing Video', category: 'Amazon', goal: 'Ranking', platform: 'Amazon' },
  { title: 'App Walkthrough Reel', category: 'App', goal: 'Installs', platform: 'Meta Ads' },
  { title: 'Course Testimonial Ad', category: 'Course', goal: 'Leads', platform: 'Meta Ads' },
];
  ...
  return (
    <div className="min-h-screen bg-background font-sans">
      ...
      <main>
        ...
        <section className="section-padding bg-light" aria-label="Top-performing content">
          <div className="container-custom">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <span className="w-8 h-0.5 bg-secondary" />
                <span className="text-sm font-medium text-secondary uppercase tracking-widest">Best UGC Work</span>
              </div>
              <h2 className="font-display text-4xl md:text-5xl font-bold text-foreground mb-4">
                Top-performing{' '}
              ...
              <p className="text-muted-foreground leading-relaxed">
                Auto-play reels showing our best D2C content with category, goal, and platform overlay.
              </p>
            </motion.div>
