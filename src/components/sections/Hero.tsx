...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    // Defer attaching to avoid forced reflow during initial paint
    const scheduleAttach = typeof requestIdleCallback !== 'undefined'
      ? requestIdleCallback
      : (cb: () => void) => setTimeout(cb, 100);

    const idleId = scheduleAttach(() => {
...
{/* 
          ...
          <motion.p
            variants={fadeUp}
            className="text-xl md:text-3xl font-medium tracking-wide text-foreground/90 max-w-3xl leading-snug mb-12 capitalize"
          >
            For which brand are you looking for?
          </motion.p>
